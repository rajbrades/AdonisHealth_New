...
export function BoostersFaq() {
  ...
  const renderSideEffectsAnswer = () => (
    <div className="text-muted-foreground leading-relaxed">
      <p className="mb-4">
        Natural boosters are generally well-tolerated with minimal side effects. Some men may experience mild mood
        changes or headaches initially. Unlike TRT, there&apos;s no concern about testicular atrophy or fertility
        suppression. We monitor your progress closely to ensure optimal results.
      </p>
      <p className="mb-2">Reported side effects of Enclomiphene Citrate may include:</p>
      <ul className="list-disc list-inside space-y-1 ml-2">
        ...
        <li>Nasopharyngitis (common cold)</li>
        <li>Blurry vision</li>
            ...
            >
              ...
              >
                <div className="px-6 pb-6 pt-0">
                  {faq.answerWithBullets ? (
                    renderSideEffectsAnswer()
                  ) : (
