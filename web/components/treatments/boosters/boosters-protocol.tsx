          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Many patients use HCG, Enclomiphene or Gonadorelin alongside TRT to help maintain fertility and
                testicular function. Your provider will help design the optimal protocol for your specific goals.
              </p>
            </div>
          </div>
        </div>
