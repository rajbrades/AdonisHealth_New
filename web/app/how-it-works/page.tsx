  ...
  return (
    <>
      ...
      <main className="bg-background">
        ...
        {/* Hero Section */}
        <section className="border-b border-border min-h-[90vh] flex items-center">
          <div className="container mx-auto px-4 py-24 md:py-32">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Link href="/get-started">
                <Button className="bg-background text-foreground border-2 border-primary hover:bg-primary hover:text-primary-foreground font-semibold px-8 h-14 text-base">
                  Let's do this
        ...
        {/* Final CTA Section */}
        <section className="relative min-h-[90vh] flex items-center justify-center border-t border-border">
