...
const steps = [
  {
    ...
    description: "Complete a comprehensive health questionnaire from home. Takes less than 10 minutes.",
    duration: "10 min",
  },
  {
    number: "02",
    ...
    description: "We'll provide a lab order for your local lab. Lab fees are separate and may be covered by insurance.",
    duration: "Same day",
  },
  {
    number: "03",
    ...
    description: "Review your results with a board-certified physician who specializes in hormone optimization.",
    duration: "30 min",
  },
  {
    number: "04",
    ...
    description: "Receive your prescribed medications shipped directly to your door in discreet packaging.",
    duration: "2-3 days",
  },
  {
    number: "05",
    ...
    description: "Regular check-ins and labs to optimize your protocol. We adjust dosing based on your response.",
    duration: "Ongoing",
  },
]

export function TRTProcess() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 md:mb-20">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            From assessment to treatment in as little as one week. Our streamlined process makes TRT accessible and
            convenient.
          </p>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-border">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="text-right">
              ...
              <div className="text-2xl font-bold text-primary mt-1">4-6 Weeks</div>
            </div>
          </div>
        </div>
      </div>
