      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 py-10 sm:py-16 lg:py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-8 sm:mt-10 justify-center px-4 sm:px-0">
            <Button
              size="lg"
              className="bg-background text-foreground border-2 border-primary hover:bg-primary hover:text-primary-foreground h-12 sm:h-14 px-6 sm:px-10 text-sm sm:text-base"
            >
              Start Assessment
        ...
        <div className="mt-10 sm:mt-16 pt-6 sm:pt-8 border-t border-border/30">
          <p className="text-center text-[10px] sm:text-xs text-muted-foreground tracking-[0.2em] sm:tracking-[0.3em] uppercase mb-4 sm:mb-6">
            Trusted by executives at
          </p>
          <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-2 sm:gap-x-8 lg:gap-x-12 gap-y-2 sm:gap-y-4 text-muted-foreground/50">
            <span className="text-xs sm:text-sm font-medium tracking-wide">FORTUNE 500</span>
            <span className="hidden sm:inline text-primary/30">|</span>
            <span className="text-xs sm:text-sm font-medium tracking-wide">TECH STARTUPS</span>
            <span className="hidden sm:inline text-primary/30">|</span>
            <span className="text-xs sm:text-sm font-medium tracking-wide">PRIVATE EQUITY</span>
            <span className="hidden sm:inline text-primary/30">|</span>
            <span className="text-xs sm:text-sm font-medium tracking-wide">PROFESSIONAL ATHLETES</span>
          </div>
        </div>
