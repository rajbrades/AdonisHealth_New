    ...
    <footer className="py-10 sm:py-12 lg:py-16 px-4 sm:px-6 border-t border-border bg-background">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-12 pb-8 sm:pb-12 border-b border-border">
          ...
          {/* Links columns */}
          {[
            { title: "Platform", items: ["Patient Portal", "Provider Portal", "Mobile App", "Lab Partners"] },
            {
              title: "Services",
              items: ["Hormone Optimization", "Executive Wellness", "Metabolic Health", "Longevity"],
            },
            { title: "Company", items: ["About Us", "Medical Team", "Careers", "Contact"] },
          ].map((column, i) => (
            <div key={i}>
