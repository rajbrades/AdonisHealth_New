...
INSERT INTO "new_Order" ("createdAt", "fulfillmentId", "id", "patientId", "status", "totalAmount", "trackingUrl", "updatedAt") SELECT "createdAt", "fulfillmentId", "id", "patientId", "status", "totalAmount", "trackingUrl", "updatedAt" FROM "Order";
DROP TABLE "Order";
